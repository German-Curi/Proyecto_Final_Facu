<!-- // estoy en html/ListadoProfesoresApellido.php -->
...
<br/><br/>
	...
	<table class="table table-bordered table-striped table-light table-sm text-center">
		<tr>
			...
			<?php foreach ($this->profesoresapellido as $pa) { ?>

			<tr class="link" onclick="location='lista-profesores?profe=<?=$pa['ID_Profesor']?>'">
						<td><?=$pa['Nombre']?></td> 
						<td><?=$pa['Apellido']?>
					</td>
