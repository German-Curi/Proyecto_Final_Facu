...
<div class="container mt-5">
	<h1 class="mx-5 my-5">Datos de Alumno</h1>
	...
	<div class="container mt-5">
		<h1 class="mx-5">Cursos y Profesores</h1>
	...
	<div class="container">
		...
		<br/>
		<input type="hidden" name="Id_Alu" value="<?= $a['ID_Alumno']?>">
		<input type="submit" value="Inscripcion a otros cursos" class="btn btn-secondary mx-5 mb-5"/>
		<br/>
	</form>
	</div>
</body>
